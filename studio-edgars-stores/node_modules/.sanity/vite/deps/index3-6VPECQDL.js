...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-EE2O5PDA.js")),
  document: (0, import_react.lazy)(() => import("./pane-MGATN4DF.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-MGATN4DF.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-2MTPELMJ.js"))
};
...
var StyledPaneLayout = gt(PaneLayout)`
  min-height: 100%;
  min-width: 320px;
`;
...
//# sourceMappingURL=index3-6VPECQDL.js.map
